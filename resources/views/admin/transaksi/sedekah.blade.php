			...
			<div class="col-md-12">
				<div class="box box-primary">
					<div class="box-header">
		            	...
		            	@endif
						<form method="get" action="{{ url('index/admin/transaksi/sedekah/search') }}" class="form-inline">
			            	...
			            	<table class="table table-bordered">
			            		...
			            		<tbody>
			            			...
			            			<tr>
			            				...
			            				<td><a href="{{url('bukti-tf/'.$dataSedekah->foto.'/?image=250')}}" data-toggle="lightbox">Bukti</a></td>
			            				<td>
			            					@if($dataSedekah->status == '0')
			            					Belum Dikonfimasi
			            					@elseif($dataSedekah->status == '1')
			            					Diterima
			            					@elseif($dataSedekah->status == '2')
			            					Ditolak
			            					@endif
			            				</td>
			            				@can('konfirmasi transaksi')
			            				<td>
			            					@if($dataSedekah->status_pembayaran == 0)
			            					<a href="javascript:;" data-id="{{ $dataSedekah->id_payment }}" data-status="1" class="btn btn-success btn-flat btn-konfirmasi"><i class="fa fa-check"></i></a>
			            					<a href="javascript:;" data-id="{{ $dataSedekah->id_payment }}" data-status="2" class="btn btn-danger btn-flat btn-konfirmasi"><i class="fa fa-times"></i></a>
			            					@endif
			            				</td>
			            				@endcan
			            			</tr>
