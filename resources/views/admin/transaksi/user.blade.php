			            	...
			            	<table class="table table-bordered">
			            		...
			            		<tbody>
			            			...
			            			<tr>
			            				...
			            				<td><img src="{{asset('bukti-tf/'.$dataUser->foto)}}" class="img-responsive" width="150"></td>
			            				<td>{{ $dataUser->status_pembayaran == 0 ? 'Belum Dikonfirmasi' : 'Sudah Dikonfirmasi' }}</td>
			            				@can('konfirmasi transaksi')
			            				<td>@if($dataUser->status_pembayaran == 0)
			            					<a href="javascript:;" id="btn-konfirmasi" data-id="{{ $dataUser->id_payment }}" class="btn btn-success btn-flat">Konfirmasi</a>
			            				@endif</td>
			            				@endcan
			            			</tr>
			            			@endforeach
