			...
			<div class="col-md-12">
				<div class="box box-primary">
		            <div class="box-body">
						...
						@endif
						<form method="post" action="{{ url('index/admin/paket/tambah/simpan') }}" enctype="multipart/form-data">
							@csrf
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="deskripsi_paket" placeholder="Deskripsi Paket" required></textarea>
							</div>
							<div class="form-group">
								<label>Gambar</label>
							...
							<div class="form-group">
								...
								<label class="radio-inline">
									<input type="radio" name="kategori" value="1" required>Haji
								</label>
								<label class="radio-inline">
									<input type="radio" name="kategori" value="2">Umroh
								</label>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" name="id_travel" class="form-control" placeholder="ID Travel">
							</div>
							<div class="form-group">
								<label>Gambar Travel</label>
								<div class="field-gambar-travel">
									<img src="" height="100" class="img-responsive" id="show-gambar-travel">
								</div>
							...
							<div class="form-group">
								...
								<input type="text" name="perjalanan" class="form-control" placeholder="Perjalanan">
							</div>
							<div class="form-group">
								<label>Kuota</label>
								<input type="numeric" name="kuota" class="form-control" placeholder="Kuota" required>
							</div>
							<div class="form-group">
								<label>Sekamar</label>
								<input type="text" name="sekamar" class="form-control" placeholder="Sekamar">
							</div>
							<div class="form-group">
