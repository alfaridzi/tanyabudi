...
<form id="frm-isi-kuota" action="{{ url('index/admin/data-kloter/bus/list-jamaah/'.$id_bus.'/tambah/simpan') }}" method="post">
	@csrf
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(document).on('click', '#btn-isi-kuota', function(e){
            e.preventDefault();
            var jawaban = confirm('Apakah anda yakin ingin menambahkan jamaah ke bus ini?');
